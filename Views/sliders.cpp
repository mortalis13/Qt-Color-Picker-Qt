...
void Sliders::setModel(SlidersColorModel *slidersColorModel){
...
void Sliders::addActions(){
  connect( ui->hSlider, SIGNAL(hueChanged(QColor)), slidersController, SIGNAL(hueChanged(QColor)) );
  connect( ui->sSlider, SIGNAL(saturationChanged(QColor)), slidersController, SIGNAL(saturationChanged(QColor)) );
  connect( ui->vSlider, SIGNAL(valueChanged(QColor)), slidersController, SIGNAL(valueChanged(QColor)) );
  
  connect( ui->rSlider, SIGNAL(redChanged(QColor)), slidersController, SIGNAL(redChanged(QColor)) );
  connect( ui->gSlider, SIGNAL(greenChanged(QColor)), slidersController, SIGNAL(greenChanged(QColor)) );
  connect( ui->bSlider, SIGNAL(blueChanged(QColor)), slidersController, SIGNAL(blueChanged(QColor)) );

  connect( ui->cSlider, SIGNAL(cyanChanged(QColor)), slidersController, SIGNAL(cyanChanged(QColor)) );
  connect( ui->mSlider, SIGNAL(magentaChanged(QColor)), slidersController, SIGNAL(magentaChanged(QColor)) );
  connect( ui->ySlider, SIGNAL(yellowChanged(QColor)), slidersController, SIGNAL(yellowChanged(QColor)) );
  connect( ui->kSlider, SIGNAL(blackChanged(QColor)), slidersController, SIGNAL(blackChanged(QColor)) );


  connect( ui->spHue, SIGNAL(valueChanged(int)), slidersController, SIGNAL(hueChanged(int)) );
  connect( ui->spSaturation, SIGNAL(valueChanged(int)), slidersController, SIGNAL(saturationChanged(int)) );
  connect( ui->spValue, SIGNAL(valueChanged(int)), slidersController, SIGNAL(valueChanged(int)) );
  
  connect( ui->spRed, SIGNAL(valueChanged(int)), slidersController, SIGNAL(redChanged(int)) );
  connect( ui->spGreen, SIGNAL(valueChanged(int)), slidersController, SIGNAL(greenChanged(int)) );
  connect( ui->spBlue, SIGNAL(valueChanged(int)), slidersController, SIGNAL(blueChanged(int)) );
  
  connect( ui->spCyan, SIGNAL(valueChanged(int)), slidersController, SIGNAL(cyanChanged(int)) );
  connect( ui->spMagenta, SIGNAL(valueChanged(int)), slidersController, SIGNAL(magentaChanged(int)) );
  connect( ui->spYellow, SIGNAL(valueChanged(int)), slidersController, SIGNAL(yellowChanged(int)) );
  connect( ui->spBlack, SIGNAL(valueChanged(int)), slidersController, SIGNAL(blackChanged(int)) );
