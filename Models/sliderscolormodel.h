#ifndef SLIDERSCOLORMODEL_H
#define SLIDERSCOLORMODEL_H
...
class SlidersColorModel : public QObject
{
  Q_OBJECT

public:
  explicit SlidersColorModel(QObject* parent=0);
  // explicit SlidersColorModel(Sliders* slidersWindow, QObject* parent=0);
